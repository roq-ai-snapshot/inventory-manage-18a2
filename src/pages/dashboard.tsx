...
import { useRoqPlatformUserProfiles, useInventoryCount, useCustomerCount, useSupplyChainCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const supplyChainStat = useSupplyChainCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Supply Chains',
      result: supplyChainStat?.data,
      isLoading: supplyChainStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
