...
import type { Prisma, customer, inventory, organization, sales, supply_chain, user } from './types';
...
interface Supply_chainSDK {
  create: <
    T extends Prisma.supply_chainCreateArgs,
    R extends CheckSelect<T, supply_chain, Prisma.supply_chainGetPayload<T>>,
  >(
    data: Prisma.SelectSubset<T, Prisma.supply_chainCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.supply_chainCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.supply_chainCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.supply_chainUpdateArgs, R extends Prisma.supply_chainGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.supply_chainUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.supply_chainUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.supply_chainUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.supply_chainUpsertArgs, R extends Prisma.supply_chainGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.supply_chainUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.supply_chainDeleteArgs, R extends Prisma.supply_chainGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.supply_chainDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.supply_chainDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.supply_chainDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <
    T extends Prisma.supply_chainFindManyArgs,
    R extends GetFindResult<Prisma.$supply_chainPayload<DefaultArgs>, T>[],
  >(
    args: Prisma.SelectSubset<T, Prisma.supply_chainFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.supply_chainCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.supply_chainCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  findFirst: <
    T extends Prisma.supply_chainFindFirstArgs,
    R extends GetFindResult<Prisma.$supply_chainPayload<DefaultArgs>, T>,
  >(
    args?: Prisma.SelectSubset<T, Prisma.supply_chainFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  public supply_chain: Supply_chainSDK;
  ...
  private initSDK() {
    ...
    this.supply_chain = {
      create: async function createSupply_chain<
        T extends Prisma.supply_chainCreateArgs,
        R extends CheckSelect<T, supply_chain, Prisma.supply_chainGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/supply_chain/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManySupply_chain<
        T extends Prisma.supply_chainCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/supply_chain/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateSupply_chain<
        T extends Prisma.supply_chainUpdateArgs,
        R extends Prisma.supply_chainGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/supply_chain/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManySupply_chain<
        T extends Prisma.supply_chainUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/supply_chain/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertSupply_chain<
        T extends Prisma.supply_chainUpsertArgs,
        R extends Prisma.supply_chainGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/supply_chain/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteSupply_chain<
        T extends Prisma.supply_chainDeleteArgs,
        R extends Prisma.supply_chainGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/supply_chain/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManySupply_chain<
        T extends Prisma.supply_chainDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.supply_chainDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/supply_chain/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManySupply_chain<
        T extends Prisma.supply_chainFindManyArgs,
        R extends GetFindResult<Prisma.$supply_chainPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.supply_chainFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/supply_chain/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countSupply_chain<T extends Prisma.supply_chainCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.supply_chainCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/supply_chain/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountSupply_chain<
        T extends Prisma.supply_chainFindManyArgs,
        R extends GetFindResult<Prisma.$supply_chainPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.supply_chainFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.supply_chain.findMany(args, options),
          ctx.supply_chain.count(
            {
              distinct,
              orderBy,
              where,
      ...
      findFirst: async function findFirstSupply_chain<
        T extends Prisma.supply_chainFindFirstArgs,
        R extends GetFindResult<Prisma.$supply_chainPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.supply_chainFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/supply_chain/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
